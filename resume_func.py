...
Original file is located at
    https://colab.research.google.com/drive/1jRA9QGDU8CYAJdX-zQJ4t9s7mAJKPyIn
"""
...
def preprocess(resume):
  ...
  resume = resume.split()
  resume = [word for word in resume if word not in sw]
  resume = ' '.join(resume)
  return resume

a= preprocess("""Skills * Programming Languages: Python (pandas, numpy, scipy, scikit-learn, matplotlib), Sql, Java, JavaScript/JQuery. * Machine learning: Regression, SVM, NaÃ¯ve Bayes, KNN, Random Forest, Decision Trees, Boosting techniques, Cluster Analysis, Word Embedding, Sentiment Analysis, Natural Language processing, Dimensionality reduction, Topic Modelling (LDA, NMF), PCA & Neural Nets. * Database Visualizations: Mysql, SqlServer, Cassandra, Hbase, ElasticSearch D3.js, DC.js, Plotly, kibana, matplotlib, ggplot, Tableau. * Others: Regular Expression, HTML, CSS, Angular 6, Logstash, Kafka, Python Flask, Git, Docker, computer vision - Open CV and understanding of Deep learning.Education Details
...
def extract_file(file):
  ...
  if fn.endswith(".pdf"):
    ...
    if textract is None:
      return "Error: textract is not installed. Cannot read .doc files."
    try:
